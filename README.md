...
AI/ML Engineer seeking entry-level opportunities in AI platforms, backend systems, and data engineering. I build production-ready AI applications using LLMs, Agentic AI, Retrieval-Augmented Generation (RAG), and scalable backend architectures. My experience includes developing LLM evaluation frameworks, agentic systems, ML pipelines, and RESTful microservices with a focus on reliability, retrieval quality, and inference optimization.
